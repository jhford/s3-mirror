CREATE TABLE IF NOT EXISTS artifacts (
  region TEXT NOT NULL, -- S3 region, e.g. us-east-1
  bucket TEXT NOT NULL, -- bucket name, e.g. taskcluster-public-artifacts
  object TEXT NOT NULL, -- object name, e.g. public/build/target.tar.gz
